  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "data-[state=checked]:bg-primary data-[state=unchecked]:bg-input focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:border-ring",
        "dark:data-[state=unchecked]:bg-input/80 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    >
